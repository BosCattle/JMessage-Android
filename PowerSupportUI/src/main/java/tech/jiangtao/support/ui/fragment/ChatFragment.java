...
public class ChatFragment extends BaseFragment
    ...
    @BindView(R2.id.chat_audio_record)
    AudioRecordButton mAudioRecord;
    ...
    public void loadOwnRealm() {
        ...
        RealmResults<VCardRealm> realms =
                mRealm.where(VCardRealm.class).equalTo("jid", StringSplitUtil.splitDivider(userJid)).findAll();
        if (realms.size() != 0) {
    ...
    public void onMessage(RecieveLastMessage message) {
