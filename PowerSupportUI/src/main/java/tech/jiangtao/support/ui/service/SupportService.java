...
public class SupportService extends Service
                ...
                public void call(Subscriber<? super AbstractXMPPConnection> subscriber) {
                    ...
                    .subscribe(abstractXMPPConnection -> {
                        ...
                        try {
                            ...
                            if (username != null && password != null && needAutoLogin && !mXMPPConnection.isAuthenticated()) {
     ...
     */
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void createAccount(RegisterAccount account) {
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void queryUser(QueryUser user) {
        mVCardManager = VCardManager.getInstanceFor(mXMPPConnection);
     ...
     */
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void deleteFriends(RosterEntryBus user) {
        mRoster = Roster.getInstanceFor(mXMPPConnection);
