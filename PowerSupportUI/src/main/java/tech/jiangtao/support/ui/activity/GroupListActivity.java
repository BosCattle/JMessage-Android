...
public class GroupListActivity extends BaseActivity implements
    ...
    @BindView(R2.id.group_swift_refresh)
    SwipeRefreshLayout mGroupSwiftRefresh;
    ...
    public void onItemClick(int position, View view) {
        ...
        mFriends.userId = "nnnnnnnnnn@muc.dc-a4b8eb92-xmpp.jiangtao.tech.";
        mFriends.nickName="nnnnnnnnnn";
