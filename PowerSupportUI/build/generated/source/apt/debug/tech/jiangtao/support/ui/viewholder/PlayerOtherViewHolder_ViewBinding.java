...
public class PlayerOtherViewHolder_ViewBinding implements Unbinder {
  private PlayerOtherViewHolder target;

  @UiThread
  public PlayerOtherViewHolder_ViewBinding(PlayerOtherViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PlayerOtherViewHolder target = this.target;
