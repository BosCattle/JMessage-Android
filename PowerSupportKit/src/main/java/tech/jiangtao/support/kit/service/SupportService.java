    ...
    public void getRoster() {
        ...
        for (RosterEntry en : set) {
            ...
            Observable.create((Observable.OnSubscribe<VCard>) subscriber -> {
                ...
                HermesEventBus.getDefault().post(new VCardRealm(StringSplitUtil.splitDivider(vCard.getFrom()), en.getName(), vCard.getField("avatar"),
                        PinYinUtils.getPinyinFirstLetter(en.getName()), PinYinUtils.ccs2Pinyin(en.getName()), true));
            }, new ErrorAction() {
                @Override
                public void call(Throwable throwable) {
                    super.call(throwable);
    ...
    public void addOrUpdateVCard(
        ...
        Observable.create((Observable.OnSubscribe<VCard>) subscriber -> {
            ...
            Observable.create((Observable.OnSubscribe<String>) subscriber -> {
                ...
                HermesEventBus.getDefault().post(new VCardRealm(StringSplitUtil.splitDivider(vCardRealm.getJid()), vCardRealm.getNickName(), vCardRealm.getAvatar(),
                        PinYinUtils.getPinyinFirstLetter(vCardRealm.getNickName()), PinYinUtils.ccs2Pinyin(vCardRealm.getNickName()), true));
